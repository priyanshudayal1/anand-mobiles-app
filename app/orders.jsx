...
import { View, Text, ActivityIndicator, TouchableOpacity, RefreshControl, Image } from "react-native";
...
export default function Orders() {
    ...
    const getStatusColor = (status) => {
        ...
        if (s.includes("shipped") || s.includes("out")) return colors.info || "#3b82f6"; // Fallback blue
                ...
                <View style={{
                    ...
                    <View>
                        <Text style={{ fontSize: 16, fontWeight: "bold", color: colors.text }}>
                            Order #{item.order_id ? item.order_id.slice(0, 8).toUpperCase() : "N/A"}
                        </Text>
                    ...
                    <View style={{
                        ...
                        <Feather name={getStatusIcon(item.status)} size={12} color={statusColor} style={{ marginRight: 4 }} />
                ...
                <View style={{ padding: 16, flexDirection: 'row' }}>
                    ...
                    <View style={{ marginLeft: 16, flex: 1, justifyContent: 'center' }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6 }}>
                            <Feather name="shopping-bag" size={14} color={colors.textSecondary} style={{ marginRight: 6 }} />
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        {item.estimated_delivery && (
                            <>
                                <Feather name="truck" size={14} color={colors.primary} style={{ marginRight: 6 }} />
                                <Text style={{ fontSize: 12, color: colors.textSecondary }}>
                                    Expected: {new Date(item.estimated_delivery).toLocaleDateString()}
                                </Text>
                            </>
                        )}
                    </View>
                    ...
                    >
                        ...
                        <Text style={{ color: "#FFF", fontSize: 12, fontWeight: "600" }}>Track Order</Text>
                    </TouchableOpacity>
                </View>
            </View>
        );
