...
export default function Profile() {
    ...
    const { user, logout, fetchUserProfile, updateUserProfileAPI, isLoading, error } =
        useAuthStore();
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            Alert.alert("Error", typeof error === 'string' ? error : "Failed to update profile");
        }
    };
        ...
        >
            ...
            <ScrollView contentContainerStyle={{ padding: 16 }}>
                ...
                {isIncomplete && (
                    ...
                    >
                        ...
                        <Text style={{ color: "#856404", fontSize: 13, marginBottom: 8 }}>
                            Your profile is missing important information. Please complete your profile.
                        </Text>
                        {!isEditing && (
                            <TouchableOpacity
                ...
                >
                    ...
                    <View style={{ gap: 16 }}>
                        ...
                        <View>
                            ...
                            <View
                                style={{
                                    backgroundColor: isEditing ? colors.backgroundSecondary : "transparent",
                        ...
                        {isEditing && (
                            <View style={{ marginTop: 10, paddingTop: 16, borderTopWidth: 1, borderTopColor: colors.borderLight }}>
                ...
                <View style={{ gap: 12, marginBottom: 30 }}>
                    {['My Orders', 'Saved Addresses', 'My Wishlist'].map((item, index) => (
                        <TouchableOpacity
                            key={index}
                            style={{
                                backgroundColor: colors.surface,
                            ...
                            onPress={() => {
                                if (item === 'My Orders') router.push('/orders');
                                else if (item === 'Saved Addresses') router.push('/addresses');
                                else if (item === 'My Wishlist') router.push('/wishlist');
                            }}
                        >
                            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                                <Ionicons
                                    name={
                                        item === 'My Orders' ? "cube-outline" :
                                            item === 'Saved Addresses' ? "location-outline" :
                                                "heart-outline"
                                    }
                                    size={22}
