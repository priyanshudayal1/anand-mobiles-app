...
export default function Cart() {
    ...
    const renderCartItem = ({ item }) => {
        ...
        const price = item.discounted_price || product.discount_price || product.price || 0;
            ...
            >
                ...
                >
                    ...
                    >
                        <Image
                            source={{
                                uri: product.image || product.images?.[0] || "https://via.placeholder.com/100",
                            }}
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={["top"]}>
            ...
            {isLoading ? (
                ...
                <View style={{ flex: 1, justifyContent: "center", alignItems: "center", padding: 20 }}>
                    ...
                    >
                        <Feather name="shopping-cart" size={50} color={colors.textSecondary} />
                    </View>
                    <Text
                        style={{
                            color: colors.text,
