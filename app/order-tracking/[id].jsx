...
export default function OrderTracking() {
    ...
    const getProgressPercentage = () => {
        ...
        const status = getDisplayStatus(currentOrder.delivery_status || currentOrder.status);
    ...
    const generateTimeline = () => {
        ...
        const currentStatus = getDisplayStatus(currentOrder.delivery_status || currentOrder.status);
        ...
        return statusOrder.map((status, index) => {
            ...
            return {
                ...
                description: historyItem?.description || getStatusDescription(status, isCompleted),
                isCompleted,
                isActive,
            };
        });
    ...
    const handleDownloadInvoice = async () => {
        ...
        try {
            ...
            const invoiceId = currentOrder?.invoice_id || currentOrder?.razorpay_order_id || id;
    ...
    const displayStatus = getDisplayStatus(currentOrder.delivery_status || currentOrder.status);
    ...
    const isPaid = displayStatus !== "Pending Payment" && displayStatus !== "Cancelled";
            ...
            >
                ...
                <View style={{ flex: 1 }}>
                    <Text style={{ fontSize: 18, fontWeight: "bold", color: colors.text }}>
                        Order #{(currentOrder.invoice_id || currentOrder.razorpay_order_id || id)?.slice(0, 12).toUpperCase()}
                    </Text>
                        ...
                        >
                            ...
                            <Text style={{ marginLeft: 8, color: colors.textSecondary }}>
                                ...
                                <Text style={{ color: colors.text, fontWeight: "600" }}>
                                    {new Date(currentOrder.estimated_delivery).toLocaleDateString("en-IN", {
                                        weekday: "short",
                                        day: "numeric",
                                        month: "short",
                                    })}
                ...
                >
                    ...
                    >
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 12 }}>
                            ...
                            <Text style={{ fontWeight: "600", color: colors.text }}>Delivery</Text>
                        </View>
                        <Text
                    ...
                    >
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 12 }}>
                            ...
                            <Text style={{ fontWeight: "600", color: colors.text }}>Partner</Text>
                        </View>
                        ...
                        {currentOrder.tracking_info?.tracking_number && (
                            <Text style={{ color: colors.primary, fontSize: 12, fontFamily: "monospace" }}>
                                #{currentOrder.tracking_info.tracking_number}
                            </Text>
                        )}
                    </View>
                    ...
                    {currentOrder.payment_details && (
                        ...
                        >
                            <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 12 }}>
                                ...
                                <Text style={{ fontWeight: "600", color: colors.text }}>Payment</Text>
                            </View>
                            <Text style={{ color: colors.text, fontWeight: "500", marginBottom: 4, textTransform: "capitalize" }}>
                                ...
                                >
                                    ...
                                    <View style={{ alignItems: "flex-end" }}>
                                        <Text style={{ fontSize: 15, fontWeight: "bold", color: colors.text }}>
                                            ₹{item.price_at_purchase || item.total_item_price || item.price}
                                        </Text>
                                        <Text style={{ fontSize: 12, color: colors.textSecondary }}>
                                            Qty: {item.quantity || 1}
                                        </Text>
                ...
                <View style={{ margin: 16, marginTop: 0 }}>
                    ...
                    >
                        {timeline.map((step, index) => {
                            ...
                            const stepColor = step.isCompleted || step.isActive
                                ? getStatusColor(step.status)
                                : colors.border;

                            return (
                                <View key={index} style={{ flexDirection: "row", minHeight: 70 }}>
                                    {/* Timeline Line */}
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center" }}>
                                ...
                                <View>
                                    ...
                                    <Text style={{ color: colors.textSecondary, fontSize: 12 }}>
                                        {currentOrder.carrier || currentOrder.tracking_info?.carrier || "Courier Partner"}
                                    </Text>
                                </View>
                            </View>
