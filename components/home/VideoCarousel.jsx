...
export default function VideoCarousel() {
    ...
    const renderVideoItem = (video, index) => {
        ...
        const thumbnail = video.thumbnail || "https://via.placeholder.com/400x225?text=Video";
        ...
        return (
            <TouchableOpacity
                ...
                activeOpacity={0.9}
            >
                <View style={{ height: VIDEO_WIDTH * 0.56, width: "100%", position: "relative" }}>
                    <Image
    ...
    return (
        <View style={{ marginTop: 8, paddingVertical: 16, backgroundColor: colors.backgroundSecondary }}>
