...
const ProductAccordions = ({ product }) => {
  ...
  // By default all sections are opened as per user request
  ...
  const AccordionSection = ({ id, label, icon: Icon, children }) => {
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            {id === "reviews" && product.total_reviews > 0 && (
              <Text
                style={{
                  fontSize: 14,
                  color: colors.textSecondary,
  ...
  return (
    <View style={{ backgroundColor: colors.white }}>
      ...
      <AccordionSection id="specifications" label="Specifications" icon={List}>
        {renderSpecifications()}
      </AccordionSection>

      <AccordionSection id="reviews" label="Reviews" icon={MessageSquare}>
        {renderReviews()}
      </AccordionSection>
    </View>
  );
