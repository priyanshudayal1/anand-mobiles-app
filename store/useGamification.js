...
export const useGamification = create((set, get) => ({
    ...
    fetchWallet: async () => {
        ...
        try {
            ...
            set({
                ...
                coinBalance: walletData.wallet?.balance || walletData.coin_balance || walletData.balance || 0,
    ...
    fetchGamificationStatus: async () => {
        try {
            ...
            console.error("Gamification status error:", error.response?.data || error.message);
            return { success: false, error: error.message };
        }
    },
    ...
    fetchReferralData: async () => {
        try {
            ...
            console.error("Referral data fetch error:", error.response?.data || error.message);
            return { success: false, error: error.message };
        }
    },
